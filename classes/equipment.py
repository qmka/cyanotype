...
class Equipment_unit:
    def __init__(self, id, name, description, weight, cost):
        self.id = id
        self.name = name
        self.description = description
        self.weight = weight
...
class Weapon(Equipment_unit):
    def __init__(self, id, name, description, weapon_type, weight, cost, damage, damage_type):
        super().__init__(id, name, description, weight, cost)
        self.weapon_type = weapon_type # melee or ranged
        self.damage = damage
        self.damage_type = damage_type


class Armor(Equipment_unit):
    def __init__(self, id, name, description, weight, cost, ac, dex_mod, strength):
        super().__init__(id, name, description, weight, cost)
        self.ac = ac
...
class Shield:
    def __init__(self, id, name, description, weight, cost, ac, strength):
        super().__init__(id, name, description, weight, cost)
        self.ac = ac
        self.strength = strength
